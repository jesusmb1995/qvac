...
TEST(RuntimeStatsRates, PureDecodeStepsComputeDecodeRate) {
  ...
  stats.recordDecodeStep(/*numActiveSequences=*/2, /*prefillTokens=*/0,
                         /*decodeTokens=*/2, milliseconds(40));
  stats.recordDecodeStep(/*numActiveSequences=*/2, /*prefillTokens=*/0,
                         /*decodeTokens=*/2, milliseconds(60));
  // 1000 * 4 / 100 = 40 tok/s.
...
TEST(RuntimeStatsRates, PurePrefillStepsComputePrefillRate) {
  ...
  stats.recordDecodeStep(/*numActiveSequences=*/2, /*prefillTokens=*/100,
                         /*decodeTokens=*/0, milliseconds(50));
...
TEST(RuntimeStatsRates, MixedStepIsChargedToDecodeNotPrefill) {
  ...
  stats.recordDecodeStep(/*numActiveSequences=*/4, /*prefillTokens=*/1,
                         /*decodeTokens=*/3, milliseconds(30));
